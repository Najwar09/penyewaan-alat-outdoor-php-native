<?php
    ...
    if($_GET['cari'])
    {
        ...
        $query =  $koneksi -> query('SELECT * FROM alat WHERE harga LIKE "%'.$cari.'%" ORDER BY id_alat DESC')->fetchAll();
    }else{
        ...
        <!-- MENAMPILKAN DAFTAR ALAT OUTDOOR PADA HALAMAN BLOG -->
            <div class="col-sm-4">
                ...
                <img src="assets/image/<?php echo $isi['gambar'];?>" class="card-img-top" style="height:200px;object-fit:cover;">
                    ...
                    <div class="card-body">
                        <center>
                            <a href="booking.php?id=<?php echo $isi['id_alat'];?>" class="btn btn-success">Booking now!</a>
                            <a href="detail.php?id=<?php echo $isi['id_alat'];?>" class="btn btn-info">Detail</a>
                        </center>
                    </div>
                </div>
            </div>
