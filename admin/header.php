...
<html lang="en">
  <head>
    <title><?php echo $title_web;?> | Rental Alat Outdoor</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    ...
    <!-- DAFTAR MENU PADA HALAMAN ADMIN -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #333;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'Daftar Alat Outdoor'){ echo 'active';}?>
                <?php if($title_web == 'Tambah Alat Outdoor'){ echo 'active';}?>
                <?php if($title_web == 'Edit Alat Outdoor'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/alat/alat.php">Daftar Alat Outdoor</a>
                </li>
